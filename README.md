...
- **Safe exploration before execution** — Plan mode lets the agent inspect your repo and produce numbered execution plans without touching any files
...
| 🗺 Planning     | Read-only Plan mode with numbered execution plans and follow-up questions |
...
- **Plan mode** is read-only. The agent inspects the repo, asks focused
  follow-up questions, and produces numbered execution plans — no file changes
  until you approve.
