...
export const openUIPromptSpec = {
  components: {
    ...
    Select: {
      ...
      description:
        "An interactive dropdown selector with reactive state binding.",
    },
    Switch: {
      signature:
        "Switch(name: string, checked: $binding<boolean>, label?: string, disabled?: boolean)",
      description:
        "A toggle switch component bound to a boolean reactive state.",
    },
    Modal: {
      signature:
        "Modal(name: string, open: $binding<boolean>, title: string, content?: any)",
      description:
        "An overlay dialog container bound to a boolean reactive state.",
    },
  },
} as PromptSpec
